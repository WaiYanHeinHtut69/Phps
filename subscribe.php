...
<br><br>
     ...
     <div class="container-fluid">
      <div class="row">
  <div class="col-sm-6">
    <div class="card order-secondary mb-3">
      <div class="card-body">
        <h5 class="card-title fs-1">Tier 1</h5>
        <p class="card-text fs-3" >1.<b>Buy an item at special discount after every 10 items.</b><br>
    2.<b>Pre released items </b> </p><br>
        <a href="tier1.php" class="btn btn-danger">10000 MMK/Month</a>
      </div>
    </div>
  </div>
  <div class="col-md-6">
    <div class="card order-secondary mb-3">
      <div class="card-body">
        ...
        <p class="card-text">1.<b>Buy an item at special discount after every 5 items.</b><br>
    2.<b>A chance to attend limted events hosted by Fiu.</b><br>
3.Chance to win monthly lucky draw.</p>
        <a href="tier2.php" class="btn btn-success">30000 MMK/Month</a>
      </div>
    </div>
  </div>
</div>
