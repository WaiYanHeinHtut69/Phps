...
<html lang="en">
   ...
   <body>
    ...
    if(isset($_POST['sub'])) {
        ...
        $query = "INSERT INTO `subscribe` VALUES ('', '$name', '$email', '$product_name', '$product_price', '$phone')";
        $con->query($query);
        echo "<script>window.location.href='tier2suc.html'</script>";   
    }
?>
...
<input type="text" id="product" name="pname" value="Tier 2"  required readonly>
<label for="price">Price</label>
<input type="text" id="price" name="price"  value="30000 MMK"  required readonly>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Are you sure you want to purchase this item?</h5>
        
      </div>
      <div class="modal-body">
        <p>1.Total cost:30000 MMK/Month</p><br>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" name="sub">Buy</button>
      </div>
    </div>
  </div>
</div>
