...
<div class='carousel-item active'>
                  ...
                  <div class='container'>
                     <h1 class='design_taital'>Chairs</h1>
                     <p class='design_text'>There are many variations of passages of high confort chair available, but the majority have suffered alteratio</p>
...
error_reporting(1);
include('connect.php');
$data="SELECT * FROM fur ORDER BY id DESC";
$val=$con->query($data);
if ($val->num_rows > 0){
while(list($id, $name,$img,$price) = mysqli_fetch_array($val)){
   echo "
                           ...
                           <div class='col-md-4'>
                              <div class='box_main'>
                                 <p class='chair_text'>$name</p>
                                 <div class='image_3' href='#'><img src='admin/images/$img'></div>
                                 <p class='chair_text'>$price MMK</p>
                                 <div class='buy_bt'><a href='buy.php?name=$name&price=$price'>Buy Now</a></div>
                              </div>
                           </div>";
}}?>
               ...
               <div class="carousel-item">
                  <div class="container">
                     <h1 class="design_taital">Bed</h1>
                     <p class="design_text">There are many variations of passages of Luxury Beds available, but the majority have suffered alteratio</p>
                     <div class="design_section_2">
                        <div class="row">
...
while(list($id, $name,$img,$price) = mysqli_fetch_array($val)){
   ...
   echo "
            ...
            <i class="fa fa-long-arrow-left" style="font-size:24px">Prev</i>
            </a>
            <a class="carousel-control-next" href="#my_slider" role="button" data-slide="next">
            <i class="fa fa-long-arrow-right" style="font-size:24px">Next</i>
            </a>
         </div>
         <div class="container">
         ...
         <div class="container">
            <div class="row">
               ...
               <div class="col-md-6">
                  ...
                  <div class="subscribe_bt"><a href="subscribe.php">Subscribe Now</a></div>
               </div>
            </div>
         </div>
      </div>
...
echo "<marquee><h2>Massage has sent successfully</h2></marquee>";
}
       ?>
       <form method="post">
         <div class="container">
               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="mail_section_1">
                        ...
                        <input type="text" class="mail_text" placeholder="Name" name="n">
                        <input type="text" class="mail_text" placeholder="Email" name="e">
                        <input type="text" class="mail_text" placeholder="Phone Number" name="p">
                        <textarea class="massage-bt" placeholder="Massage" rows="5" id="comment" name="msg"></textarea>
                        <div class="send_bt"><input type="submit" name="sub" value="Send"></div>
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="map_main">
